...
public class addrooms extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cleaning Status");
        ...
        avail.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        avail.setForeground(new java.awt.Color(0, 0, 0));
        avail.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Available", "Occupied" }));
        ...
        cleaning.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        cleaning.setForeground(new java.awt.Color(0, 0, 0));
        cleaning.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cleaned", "Not Cleaned" }));
        ...
        bedtype.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("E:\\html\\pexels-pixabay-271639.jpg")); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(95, 95, 95)
                            .addComponent(avail, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(147, 147, 147)
                        .addComponent(cleaning, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(room, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(27, 27, 27)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String a=room.getText();
        String b=(String)avail.getSelectedItem();
        String c=(String)cleaning.getSelectedItem();
        String d=price.getText();
        String e=(String)bedtype.getSelectedItem();
        ...
        try{
            conn c1=new conn();
            String q1="insert into rooms values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"')";
            c1.s.executeUpdate(q1);
            JOptionPane.showMessageDialog(null,"Successfully Added Room No: "+room.getText());
    ...
    private javax.swing.JComboBox<String> cleaning;
